...
import com.shuframework.commonbase.enums.IdGeneratorTypeEnum;
import com.shuframework.commonbase.util.generator.IdWorker;
...
public class SystemUtil {
     ...
     *
     * @param @param length 	最多9位长度
     */
    public static String getRandomId(int length) {
        return DateUtil.today2Str() + RandomUtil.getInstance().randomByLength2Int(length);
    }
    ...
    public static Integer verifyCode() {
        //生成的随机数是线性可预测的
        return RandomUtil.getInstance().randomByLength2Int(6);
    }
    ...
    public static String verifyCodeHasLetter() {
        //生成的随机数是线性可预测的
        return RandomUtil.getInstance().verifyCodeHasLetter(6);
    }
    ...
    public static String verifyCodeHasLetter(int length) {
        //生成的随机数是线性可预测的
        return RandomUtil.getInstance().verifyCodeHasLetter(length);
    }
