...
//		boolean required = true;
		...
		boolean flag = SystemUtil.checkStrLength(str, required, limitLength);
...
//		System.out.println(ValidateUtil.isFloat(numStr3, 3));
	...
	public void isEmpty_Number() {
		...
		System.out.println(SystemUtil.isEmpty(intNum1));
		Integer intNum2 = 0;
		System.out.println(SystemUtil.isEmpty(intNum2));
		int intNum3 = 0;
		System.out.println(SystemUtil.isEmpty(intNum3));
		Integer intNum4 = 200;
		System.out.println(SystemUtil.isEmpty(intNum4));
		int intNum5 = 200;
		System.out.println(SystemUtil.isEmpty(intNum5));
		
		System.out.println("---Long---");
		Long longNum1 = null;
		System.out.println(SystemUtil.isEmpty(longNum1));
		Long longNum2 = 0L;
		System.out.println(SystemUtil.isEmpty(longNum2));
		long longNum3 = 0L;
		System.out.println(SystemUtil.isEmpty(longNum3));
		Long longNum4 = 200L;
		System.out.println(SystemUtil.isEmpty(longNum4));
		long longNum5 = 200L;
		System.out.println(SystemUtil.isEmpty(longNum5));
	}
	...
	public void isEmpty_Collection() {
		...
		System.out.println(SystemUtil.isEmpty(list1));
		List<String> list2 = new ArrayList<>();
		System.out.println(SystemUtil.isEmpty(list2));
		...
		System.out.println(SystemUtil.isEmpty(set1));
		Set<String> set2 = new HashSet<>();
		System.out.println(SystemUtil.isEmpty(set2));
		...
		System.out.println(SystemUtil.isEmpty(queue1));
		Queue<String> queue2 = new ArrayDeque<>();
		System.out.println(SystemUtil.isEmpty(queue2));
	...
	public void isEmpty_Array() {
		...
		String[] array1 = null;
		System.out.println(SystemUtil.isEmpty(array1));
		String[] array2 = new String[]{};//true
		System.out.println(SystemUtil.isEmpty(array2));
		//这种是3个null
		String[] array3 = new String[3];//false
		System.out.println(SystemUtil.isEmpty(array3));
		
		System.out.println("---父为不是Object的对象数组---");
		List<String>[] notObj1 = null;
		System.out.println(SystemUtil.isEmpty(notObj1));
	}
	...
	public void isEmpty_String() {
		...
		String str1 = null;
		System.out.println(SystemUtil.isEmpty(str1));
		String str2 = "";
		System.out.println(SystemUtil.isEmpty(str2));
		String str3 = " ";
		System.out.println(SystemUtil.isEmpty(str3));//true
		String str4 = "a b";
		System.out.println(SystemUtil.isEmpty(str4));
		String str5 = "ab";
		System.out.println(SystemUtil.isEmpty(str5));
		
		System.out.println("---isEmptyUnTrim---");
		System.out.println(SystemUtil.isEmptyUnTrim(str1));
		System.out.println(SystemUtil.isEmptyUnTrim(str2));
		System.out.println(SystemUtil.isEmptyUnTrim(str3));//false
		System.out.println(SystemUtil.isEmptyUnTrim(str4));
		System.out.println(SystemUtil.isEmptyUnTrim(str5));
	}
