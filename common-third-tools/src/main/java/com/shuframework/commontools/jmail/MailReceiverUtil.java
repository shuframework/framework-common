...
public class MailReceiverUtil {
	...
	public MailReceiverUtil(MailReceiverInfo receiverInfo) {
...
//		}
		...
		Authenticator auth = new Authenticator() {
			...
			public PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication(receiverInfo.getUserName(), receiverInfo.getPassword());
			}
		};
		//创建session
		Session session = Session.getInstance(this.receiverInfo.getProperties(), auth);
...
//			System.out.println("Other: " + disposition);
	...
	public static void main(String[] args) throws Exception {
		...
		MailReceiverUtil receiver = new MailReceiverUtil(receiverInfo);
